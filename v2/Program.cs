...
namespace Cell
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			{
				new Fort { BirthSpeed = 0, ID = 1, FortOwner = "p1", DefendingGuys = bot1.SetStartingArmy(), Location = new Point { X = 1, Y = 1 } },
				new Fort { BirthSpeed = 0, ID = 2, FortOwner = "p2", DefendingGuys = bot2.SetStartingArmy(), Location = new Point { X = 8, Y = 8 } }
			};
